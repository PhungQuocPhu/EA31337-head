...
struct IndicatorDataEntryValue {
  // Added for MetaEditor build 5660+: keep default ctor for existing call sites
  IndicatorDataEntryValue() {}
  // Prefer ctor over deprecated init-via-operator=
  IndicatorDataEntryValue(const double& v) { *this = v; }
