 ...
 *
 * NOTE: MetaEditor build 5660 introduced stricter rules around inheritance/method hiding
 * and reference conversions for MqlTrade* structs. The original proxy implementation
 * is disabled here to keep compilation working.
 */
struct MqlTradeRequestProxy {
  MqlTradeRequestProxy(MqlTradeRequest &/*req*/) {}
  SerializerNodeType Serialize(Serializer &/*s*/) { return SerializerNodeObject; }
};

/**
 * Proxy class used to serialize MqlTradeResult object.
 *
 * NOTE: Disabled for MetaEditor build 5660 compatibility.
 */
struct MqlTradeResultProxy {
  MqlTradeResultProxy(MqlTradeResult &/*res*/) {}
  SerializerNodeType Serialize(Serializer &/*s*/) { return SerializerNodeObject; }
};
